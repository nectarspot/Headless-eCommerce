            ...
            <div className="section-heading text-center">
                ...
                <Row className="align-items-center">
                    ...
                    <Col md={12} lg={6}>
                        ...
                        src="https://cdn.shopify.com/s/files/1/0569/2378/3325/files/triton-524x333.png?v=1623051863"
                    ...
                    <Col md={12} lg={6}>
                        ...
                        <Link to="/product/triton" className="read-more tab-center">Shop Now</Link>
                    </Col>
                </Row>
            </Container>
        </div>
